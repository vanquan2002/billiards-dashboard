...
const Footer = () => {
  return (
    <div className="z-30 lg:hidden fixed left-0 bottom-0 w-full bg-neutral-900 rounded-t-3xl px-5 pt-6 pb-9 flex justify-between">
      <div className="flex flex-col items-center gap-1.5 text-white">
        <button className="flex items-center justify-center w-11 h-11 bg-neutral-800 rounded-lg border border-neutral-700">
